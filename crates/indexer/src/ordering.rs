...
/// Encode chain ordering tuple (block, tx, log) into a compact `u64`.
///
...
///
/// Note: this value is informational only; canonical latest-wins ordering uses
/// explicit `(block_number, tx_index, log_index)` comparisons in storage queries.
